...
- **Dernière session** : Session 13 — programme coach 4 jours/semaine ajouté comme routines par défaut :
  ...
  - ℹ️ **En attente** : l'utilisateur a 5 anciennes routines (Push/Pull/Legs/Upper/Lower) qui recoupent en partie le nouveau programme — pas supprimées, à faire sur confirmation explicite.
